    ...
    render () {
        ...
        return (
            <div className={classes.Modelo}>
                ...
                <form onSubmit={this.submitHandler} className="pure-form pure-form-aligned">            
                    <fieldset>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Anexo</label>
                            <select style={{width: "45%", marginLeft:"14px"}} value={this.state.persona.NomAne} id="state" className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"NomAne")}}>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Estado Civil</label>
                            <select style={{width: "45%", marginLeft:"14px"}} id="state" className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"DesCiv")}}>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Sexo</label>
                            <select style={{width: "45%", marginLeft:"14px"}} id="state" className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Sexo")}}>
                                <option>M</option>
                                <option>F</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Ocupación</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"DesOcu")}}>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Distrito</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"NomDis")}}>
                                <option>Palca</option>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Provincia</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"NomPro")}}>
                                <option>Tarma</option>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">NomDep</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"NomDep")}}>
                                <option>Junín</option>
                                <option>Lima</option>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">tipo</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"tipo")}}>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Escogido</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"AsaSes")}}>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">Tipo Documento</label>
                            <select style={{width: "45%", marginLeft:"14px"}}className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"DesDoc")}}>
                                <option>D.N.I.</option>
                                <option>L.E.</option>
                                <option>L. M.</option>
                                <option>R U C</option>
                    ...
                    <div className="pure-control-group">
                        <label htmlFor="state">¿Activo?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    <div className="pure-control-group">
                        <label >¿Activo 04?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo04")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 06?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo06")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 08?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo08")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 10?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo10")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 12?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo12")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 14?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo14")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
                    ...
                    <div className="pure-control-group">
                        <label >¿Activo 16?</label>
                            <select style={{width: "45%", marginLeft:"14px"}} className="pure-input-1-2" onChange={(evt)=>{this.cambiar(evt ,"Activo16")}}>
                                <option>Si</option>
                                <option>No</option>
                            </select>
                    </div>
